# Generated by Django 3.2.3 on 2024-07-11 18:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Это имя пользователя уже занято!'}, max_length=20, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), users.custom_validators.validate_username], verbose_name='Имя пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribers', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
            ],
            options={
